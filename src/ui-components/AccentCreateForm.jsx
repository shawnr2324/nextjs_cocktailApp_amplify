...
import { createAccent } from "../graphql/mutations";
export default function AccentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAccent.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AccentCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
