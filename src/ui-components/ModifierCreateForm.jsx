...
import { createModifier } from "../graphql/mutations";
export default function ModifierCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createModifier.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ModifierCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
