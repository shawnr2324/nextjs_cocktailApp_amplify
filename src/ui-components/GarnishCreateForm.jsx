...
import { createGarnish } from "../graphql/mutations";
export default function GarnishCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createGarnish.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "GarnishCreateForm")}
      {...rest}
    >
      <SelectField
        label="Name"
