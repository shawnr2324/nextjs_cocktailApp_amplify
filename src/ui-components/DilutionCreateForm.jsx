...
import { createDilution } from "../graphql/mutations";
export default function DilutionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createDilution.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DilutionCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
